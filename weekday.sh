...
#Ce script permet d'afficher les jours de la semaine pour une date donnée, année après année sur la période comprise entre année1 et année2
...
usage(){
    ...
    -a : Défini l'année de début (année1). Doit contenir 4 chiffres
    -A : Défini l'année de fin (année2). Doit contenir 4 chiffres
    -m : Défini le mois
    -j : Défini le jour
"
    exit 1
